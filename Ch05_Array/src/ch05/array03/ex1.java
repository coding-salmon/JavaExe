...
public class ex1 {
	...
	public static void main(String[] args) {
		...
		// 참조값(해시태그)이 들어있고
		// 실제 배열의 값들은 힙 메모리에 위치한다.
		//정식 선언은 int[] kor = new int[3] 이지만
		//프로그래머 편의를 위해 아래처럼 초기화를 허용한다.
		// c언어때부터의 관습이다.
		
		int[] kor = {98,99,89};
		System.out.println("배열의크기: " + kor.length);
		
		int[] math = {100,80,78,68,90};
		System.out.println("배열의크기: " + math.length);
		

		int[] eng = new int[] {100,80,78,68};
		System.out.println("배열의크기: " + eng.length);
