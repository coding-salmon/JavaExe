...
//	int paperRemains, int inkRemainders
	...
	public void answer(Scanner sc) {
		...
		ch09.Resolve14.resolve14.question01.InkJetPrinter ijP = 
				new ch09.Resolve14.resolve14.question01.InkJetPrinter("HP-264", "HP", 
						ch09.Resolve14.resolve14.question01.P_INTERFACE.USB, 20, 100, 50);
		ijP.print();
		ijP.print();
		ijP.print();
		System.out.println(ijP);
		
		ch09.Resolve14.resolve14.question01.LaserPrinter lP = 
				new ch09.Resolve14.resolve14.question01.LaserPrinter("Samsung-111", "Samsung", 
						ch09.Resolve14.resolve14.question01.P_INTERFACE.PARALLEL_PORT, 20, 100, 100);
		lP.print();
		lP.print();
		lP.print();
